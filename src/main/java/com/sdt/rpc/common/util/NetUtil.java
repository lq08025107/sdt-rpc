...
public class NetUtil {
    ...
    private static final Pattern HOST_IP_PATTERN = Pattern.compile("(192|10)(\\.\\d{1,3})(\\.\\d{1,2})(\\.\\d{1,3})$");
    ...
    public static boolean isInvalidLocalHost(String host) {
        return host == null
                ...
                || host.equals("0.0.0.0")
                || (LOCAL_IP_PATTERN.matcher(host).matches());
 //               || (HOST_IP_PATTERN.matcher(host).matches());
    }
    ...
    private static boolean isValidAddress(InetAddress address) {
        ...
        return (name != null
                ...
                && HOST_IP_PATTERN.matcher(name).matches();
    }
